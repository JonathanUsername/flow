...
let print_version () =
  print_endline (Printf.sprintf "Flow, a static type checker for JavaScript (with whitelist), version %s \nIn memory of the original Flo\n %s" Flow_version.version flo)
